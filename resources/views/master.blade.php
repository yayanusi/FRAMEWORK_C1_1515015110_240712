...
<head>
	<meta charset="utf-8">
	<title>@yield('page_title', 'Index') | Pemrograman Pamwork</title>
...
{{Session::get('informasi')}}
	...
	<nav class="navbar navbar-default navbar-fixed-bottom">
		<footer class="container">
			...
			Created by <a href="http:twitter.com/triasbrata"><span><i class="fa fa-twitter" style="color: #1da1f2">yowww</i></span></a>
			<!-- please dont delete this-->
		</footer>
	</nav>
